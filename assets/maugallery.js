    ...
    return this.each(function() {
     ...
     // Parcours de chaque élément enfant de la galerie 
      $(this)
        ...
        .each(function(index) {
          // Adapte l'élément image pour une meilleure réactivité
...
// Création de la modale lightbox
  createLightBox(gallery, lightboxId, navigation) {
      ...
      if (navigation) {
          $(".mg-prev").click(this.prevImage)
          $(".mg-next").click(this.nextImage)
      }
    },
    // Affiche les balises pour filtrer les images
    ...
    // Filtrage des images par balise
    filterByTag() {
